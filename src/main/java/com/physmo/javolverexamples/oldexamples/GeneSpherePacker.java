 ...
 */
class GeneSpherePacker extends Individual {
	...
	public GeneSpherePacker(int numSpheres) {
		this.numSpheres = numSpheres;
		dna.init(numSpheres*objectSize);
		for (int i=0;i<numSpheres*objectSize;i+=3) {
	...
	{
		return (Individual)(new GeneSpherePacker(this.numSpheres));
	}
