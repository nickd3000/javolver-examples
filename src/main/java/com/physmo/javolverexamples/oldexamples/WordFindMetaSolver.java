package com.physmo.javolverexamples.oldexamples;
...
public class WordFindMetaSolver {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < 500; j++) {
            ...
            //com.physmo.javolverexamples.GeneWord gene = (com.physmo.javolverexamples.GeneWord)javolver.findBestScoringIndividual(javolver.getPool());
            GeneWordMetaSolver gene = (GeneWordMetaSolver)javolver.findBestScoringIndividual();
