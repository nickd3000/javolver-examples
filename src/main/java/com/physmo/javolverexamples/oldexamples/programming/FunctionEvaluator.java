...
import com.physmo.javolverexamples.programming.ProgramEvaluator;
...
public class FunctionEvaluator implements ProgramEvaluator {
    ...
    @Override
    public void preEvaluateStep(com.physmo.javolverexamples.programming.SimpleMachine sm, Chromosome dna, double step) {
        sm.regA = inputValue(step);
    }

    @Override
    public double evaluate(com.physmo.javolverexamples.programming.SimpleMachine sm, Chromosome dna, double step) {
        double score = 0;
